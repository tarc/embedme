...
> stdout does not match
    ...
    Skipped 0 files ignored in '.gitignore'␊
      Analysing test/fixtures/fixture-in-place.md...␊
       ...
       test/fixtures/fixture-in-place.md#L445-L461 Embedded 13 lines from file snippets/sample.nix␊
       test/fixtures/fixture-in-place.md#L465-L471 Embedded 3 lines from file snippets/sample␊
       test/fixtures/fixture-in-place.md#L475-L486 Embedded 8 lines from file snippets/sample.cs#L6-L13␊
       test/fixtures/fixture-in-place.md#L490-L497 Embedded 4 lines from file snippets/sample.ts␊
       test/fixtures/fixture-in-place.md#L503-L505 "Ignore next" comment detected, skipping code block...␊
       test/fixtures/fixture-in-place.md#L511-L513 "Ignore next" comment detected, skipping code block...␊
       test/fixtures/fixture-in-place.md#L519-L524 Embedded 4 lines from file snippets/sample.ts␊
       test/fixtures/fixture-in-place.md#L530-L535 Embedded 4 lines from file snippets/sample.json␊
       test/fixtures/fixture-in-place.md#L541-L542 Code block is empty & no preceding embedme comment, skipping...␊
       test/fixtures/fixture-in-place.md#L546-L548 Unsupported file extension [binary], supported extensions are txt, ts, js, re, scss, rust, java, cpp, c, html, xml, md, yaml, json, json5, py, bash, sh, ps1, go, objectivec, php, cs, swift, rb, kotlin, scala, cr, puml, mermaid, cmake, proto, sql, hs, ino, jsx, tsx, css, nix, skipping code block␊
       test/fixtures/fixture-in-place.md#L552-L554 No code extension detected, skipping code block...␊
       test/fixtures/fixture-in-place.md#L558-L560 No comment detected in first line for block with extension ts␊
       test/fixtures/fixture-in-place.md#L564-L566 Incorrectly formatted line numbering string snippets/sample.ts#L1-2, Expecting Github formatting e.g. #L10-L20␊
       test/fixtures/fixture-in-place.md#L570-L572 Code block is empty & no preceding embedme comment, skipping...␊
